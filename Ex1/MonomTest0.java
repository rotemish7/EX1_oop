...
public class MonomTest0 {
	...
	private static void test2() {
		...
		Monom d2 = new Monom (2,1);
		Monom d3 = new Monom (4,7);
		d2.add(d);
		//d.add(d3); // exception
		System.out.println("*) d+d2: " + d2 + ", d+d3: " + d);
		d2.multipy(d); // be attention: d2 = 3x (because we do d2+d)
		d.multipy(d3);
		System.out.println("*) d*d2: " + d2 + ", d*d3: " + d);
